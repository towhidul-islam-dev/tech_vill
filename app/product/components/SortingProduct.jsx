...
const SortProduct = ({sortOptions,sortData,setSortData}) => {
    ...
    >
      <div className="relative">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="absolute z-10 right-0 mt-2 overflow-x-hidden bg-gray-100 border border-gray-300 rounded-md max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none w-full min-w-max ">
