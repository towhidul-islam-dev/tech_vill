...
function page() {
  return (
    <div className="grid place-items-center">
      <div className="md:bg-gray-100 md:py-28 xl:p-24 capitalize md:grid md:grid-cols-2 md:place-items-center gap-4 w-full max-w-7xl">
        <div className="relative border-3 border-red-500">
          <div className="absolute w-56 h-56 top-52 hidden md:block left-36 xl:left-48 bg-gradient-to-r rounded-full from-violet-900  via-purple-500 to-orange-500 "></div>
          <div className="absolute w-44 h-44 top-24 left-20 hidden md:block bg-gradient-to-r rounded-full from-purple-900 via-violet-500 to-pink-500"></div>

          <div className="hidden md:block bg-white/30 backdrop-blur-lg backdrop-brightness-100 border border-violet-200 rounded-md p-8 space-y-5">
            <div className=""></div>
            <h2 className="uppercase pb-8 text-4xl text-violet-900 font-extrabold">
        ...
        <div className="py-20 md:py-0 p-4 lg:p-12 grid place-items-center">
